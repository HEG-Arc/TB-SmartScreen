...
namespace SCE_ProductionChain.Util
{
    public class GenerateUsers
    {
        ...
        public List<User> getUsers()
        {
            ...
            users.Add(new User(0, "Jeff Sokoli", "USER-JEFF-SOKOLI-732195", generateJeffsCalendar()));
            users.Add(new User(0, "Marc Abraham", "USER-MARC-ABRAHAM-789554", generateMarcsCalendar()));
            return users;
        }
